...
Sobald sich ein editierbarer Profilwert ändert, bleibt oben im Profilbereich ein Hinweis auf ungespeicherte Änderungen sichtbar. Paperless-Verbindung sowie Scan- und Upload-Vorgaben werden weiterhin getrennt gespeichert; der Status unmittelbar neben der jeweiligen Aktion zeigt Prüfung, Erfolg oder Fehler. Das Speichern eines Bereichs verwirft keine Änderungen im anderen. Bei Navigation innerhalb der Anwendung sowie beim Neuladen oder Schließen des Tabs bittet der Browser vor dem Verwerfen ungespeicherter Profiländerungen um Bestätigung.
