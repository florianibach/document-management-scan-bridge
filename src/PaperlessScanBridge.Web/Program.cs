...
app.MapGet("/signed-out", () => Results.Content("""<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Signed out</title><link rel="stylesheet" href="/lib/bootstrap/dist/css/bootstrap.min.css"></head><body class="p-3"><main class="container py-4"><h1>Signed out</h1><div class="alert alert-success">You have been signed out of Scan Bridge. If the identity provider was unavailable, the local session was still ended safely.</div><a class="btn btn-primary" href="/signin">Sign in again</a></main></body></html>""", "text/html")).AllowAnonymous();
