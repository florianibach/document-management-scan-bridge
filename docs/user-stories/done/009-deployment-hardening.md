...
- Deployment documentation now covers host networking, secrets, persistent and temporary volumes, backup, restore, upgrade, rollback, graceful shutdown, logs, and resource expectations.
