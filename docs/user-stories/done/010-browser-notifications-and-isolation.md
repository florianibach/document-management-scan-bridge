...
- `scanNotifications.js` owns permission, browser-tab preference, notification delivery, focus handling, and event-key deduplication.
...
- Notifications require the page to remain open. Web Push for a completely closed browser would require a service worker and push subscription endpoint.
