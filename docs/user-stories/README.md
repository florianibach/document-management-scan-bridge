...
| [US-018](done/018-first-scan-honors-adf-after-container-start.md) | First scan honors ADF after container start (done) | The first scan uses the selected feeder source reliably |
