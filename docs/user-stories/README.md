...
| [US-015](done/015-guided-scan-and-manual-duplex-states.md) | Guided scan and manual duplex states (done) | Simplex and manual duplex scans use explicit, recoverable UI states |
